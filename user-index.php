            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse nav-responsive-list" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link js-scroll-trigger" href="howto.pdf">Guidebook</a>
                        </li><!--/.nav-item-->
                        <li class="nav-item">
                            <a class="nav-link js-scroll-trigger" href="https://www.google.com/maps/d/u/1/edit?mid=1bueiOTbkCEPaFmGEiQoEpl9VlzKCTrD5&ll=14.365375032066165%2C101.36685480000006&z=11">Offline Map</a>
                        </li><!--/.nav-item-->
                        <li class="nav-item">
