    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#exampleModal">เพิ่มข้อมูลรถพยาบาล</button>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <form action="adminem.php" method="POST">
                    ...
                    <tbody>
                      ...
                      ?>
                        ...
                        <tr>
                          ...
                          ?>
                          <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editmodal<?php echo $i; ?>" id="<? $info['Username']; ?> " name='Edit'>แก้ไขข้อมูล</button> </td>
                          <td><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deletemodal<?php echo $i; ?>" id="<? $info['Username']; ?> " name='Delete'>ลบข้อมูล</button> </td>
                        </tr>
                      <?php
                        $i++;
                      }
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary btn-add" onClick="" id="btnadd">ยืนยัน</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <?php for ($i = 0; $i < sizeof($_SESSION['a']); $i++) { ?>
    ...
    <div class="modal fade" id="editmodal<?php echo $i; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title" id="exampleModalLabel">แก้ไขข้อมูลรถพยาบาล</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">ยกเลิก</button>
            <button type="submit" class="btn btn-primary btn-add" id="">ยืนยัน</button>
          </div>
          </form>
        </div>
      </div>
  ...
  <?php for ($i = 0; $i < sizeof($_SESSION['a']); $i++) { ?>
    ...
    <div class="modal fade" id="deletemodal<?php echo $i; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title" id="exampleModalLabel">ลบข้อมูลรถพยาบาล</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          ...
          <div class="modal-body">
            ...
            <form id="del_user<?php echo $i; ?>" method="post" action="delambu.php">
              ...
              <div class="form-group">
                <label for="Tel" class="control-label">Tel:</label>
                <input type="text" class="form-control" id="Tel" name="Tel" readonly="readonly" value="<?php echo $_SESSION['Te'][$i]; ?>" autocomplete="off">
              </div>
              <div class="form-group">
                <label for="Email" class="control-label">Email:</label>
                <input type="text" class="form-control" id="Email" name="Email" autocomplete="off" readonly="readonly" value="<?php echo $_SESSION['s'][$i]; ?>">
